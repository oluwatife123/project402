...
export default function NavBar() {
	return (
		<div className="w-full px-4 py-3 bg-white shadow-md flex flex-col md:flex-row md:justify-between md:items-center gap-4 md:gap-0">
			{/* Logo */}
			<h1 className="text-[#195FA4] font-semibold text-2xl md:text-3xl">medu</h1>

			{/* Center content */}
			<div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto md:flex-1 md:justify-center">
				{/* Location */}
				<div className="flex items-center gap-2 text-[#195FA4]">
				...
				{/* Search Button */}
				<button className="bg-[#195FA4E5] text-white px-4 py-2 rounded-md text-sm">
					Search
				</button>
			</div>
			...
			<div className="flex items-center justify-end gap-3 w-full md:w-auto">
				<div className="flex items-center gap-2 cursor-pointer text-[#195FA4] text-sm">
